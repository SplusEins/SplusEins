...
export default {
  ...
  defaults: {
    ...
    dsCalendarApp: {
      ...
      labels: {
        next: (type) => type ? 'Nächste ' + type.label.toLowerCase() : 'Weiter',
        prev: (type) => type ? 'Letzte ' + type.label.toLowerCase() : 'Zurück',
    ...
    dsDaysView: {
      hours: [
        '    ', '01:00', '02:00', '03:00', '04:00', '05:00', '', '07:00', '08:00', '09:00', '10:00', '11:00',
