<template>
  <v-container fluid>
    <div>
      <v-tabs :value="activeTab" center-active show-arrows>
        <v-tab v-for="(item, idx) in plans" :key="item.id" :value="idx" ripple>
          {{ item.name }}
        ...
        <v-tab-item v-for="item in plans" class="pa-1 pa-md-1" :key="item.id">
          <v-container grid-list-md>
            <v-layout row wrap>
              <v-flex md6 xs12 style="max-width: 100%; flex-basis: 100%">
                <v-card flat>
                  <div
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        class="d-flex flex-wrap align-center text-body-2 text--secondary"
                      >
                        <v-chip class="ma-1" small outlined>
                          <v-icon left small color="orange">
                            {{ mdiCarrot }}
                          </v-icon>
                          Vegetarisch
                        </v-chip>
                    ...
                    <div class="py-2" v-else>
                      ...
                      >
                        <template>
                          ...
                          >
                            <v-row dense class="carousel-control-padding">
                              <v-col v-for="(_, i) in 3" :key="i">
                                <mensa-dayplan
                                  v-if="dayPlanGroup[i]"
                                  :plan="dayPlanGroup[i]"
                                />
